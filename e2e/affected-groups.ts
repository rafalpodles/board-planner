...
const OWNED: readonly { prefix: string; groups: readonly GroupName[] }[] = [
  ...
  // Their failed reads are pinned in failed-read-states.spec.ts, which is in the project group
  ...
  { prefix: "src/app/api/projects/[projectId]/notifications/", groups: ["automation", "project"] },
  { prefix: "src/app/api/projects/[projectId]/members/", groups: ["people", "project"] },
