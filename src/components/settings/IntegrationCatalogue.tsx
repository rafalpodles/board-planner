...
export const INTEGRATIONS: Definition[] = [
  {
    ...
    isConfigured: (p) => p.repositoryProvider === "github" || !!p.githubTokenSet,
    summary: (p) => p.repositoryUrl || "Connected",
  },
  {
    id: "gitlab",
    brand: "gitlab",
    ...
    isConfigured: (p) => p.repositoryProvider === "gitlab" || !!p.gitlabTokenSet,
    summary: (p) => p.repositoryUrl || "Connected",
  },
  {
    id: "coda",
