...
// Exported for the same reason the thresholds below are: a spec imports the real number rather
// than copying it, so the test cannot silently drift from the value it is pinning (BP-409).
