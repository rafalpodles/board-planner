 ...
 *  and a project's member list — cannot drift from the tests that assert it, and so it never grows
 *  a verb: it runs after a create, a save, a delete and a grant alike. */
