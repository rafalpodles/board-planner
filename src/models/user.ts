...
// so without this an admin's user list would carry every colleague's stored chat destination.
// Projects strip theirs the same way, in sanitizeProjectSecrets.
